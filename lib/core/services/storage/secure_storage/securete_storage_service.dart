...
class SecurityStorageService implements ISecureStorageService {
  ...
  @override
  Future<void> saveCredentials(AuthModel credentials) async {
    try {
  ...
  @override
  Future<AuthModel?> loadCredentials() async {
...
abstract interface class ISecureStorageService {
  Future<void> saveCredentials(AuthModel credentials);
  Future<AuthModel?> loadCredentials();
