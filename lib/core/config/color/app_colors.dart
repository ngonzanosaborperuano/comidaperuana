...
class AppColors {
  ...
  static const MaterialColor backgroundDark = MaterialColor(
    0xFF0d1116,
    <int, Color>{},
  );
  ...
  static const MaterialColor backgroundCardDark = MaterialColor(
    0xFF161b22,
    <int, Color>{},
  );
  ...
  static const MaterialColor errorText = MaterialColor(
    0xFFF7B7CD,
    <int, Color>{},
  );
  ...
  static const MaterialColor textSecondaryDark = MaterialColor(
    0xFFfe9e76,
    <int, Color>{},
  );
  ...
  static const MaterialColor brownDark = MaterialColor(
    0xFFB45309,
    <int, Color>{},
  );
  ...
  static const MaterialColor slate500 = MaterialColor(
    0xFF64748B,
    <int, Color>{},
  );

  /// Gris oscuro utilizado para fondos y texto.
  static const MaterialColor slate700 = MaterialColor(
    0xFF334155,
    <int, Color>{},
  );

  // Colores de PayU
  static const MaterialColor payuGreen = MaterialColor(
    0xFF00A650,
    <int, Color>{},
  );
  static const MaterialColor payuOrange = MaterialColor(
    0xFFFF6B35,
    <int, Color>{},
  );
  static const MaterialColor payuDarkGray = MaterialColor(
    0xFF2C3E50,
    <int, Color>{},
  );

  static const MaterialColor payuGreenDark = MaterialColor(
    0xFF064E3B,
    <int, Color>{},
  );
  static const MaterialColor payuGreenLight = MaterialColor(
    0xFFA7F3D0,
    <int, Color>{},
  );
  ...
  static const MaterialColor slate800 = MaterialColor(
    0xFF1E293B,
    <int, Color>{},
  );

  static const MaterialColor emerald700 = MaterialColor(
    0xFF047857,
    <int, Color>{},
  );

  static const MaterialColor amber50 = MaterialColor(
    0xFFFFFBEB,
    <int, Color>{},
  );

  static const MaterialColor emerald800 = MaterialColor(
    0xFF065F46,
    <int, Color>{},
  );

  static const MaterialColor emerald600 = MaterialColor(
    0xFF166534,
    <int, Color>{},
  );

  static const MaterialColor amber700 = MaterialColor(
    0xFF854D0E,
    <int, Color>{},
  );
  ...
  static const MaterialColor rose700 = MaterialColor(
    0xFF9F1239,
    <int, Color>{},
  );

  static const MaterialColor emerald50 = MaterialColor(
    0xFFDCFCE7,
    <int, Color>{},
  );

  static const MaterialColor slate25 = MaterialColor(
    0xFFF8FAFC,
    <int, Color>{},
  );
  ...
  static const MaterialColor yellow100 = MaterialColor(
    0xFFFEF9C3,
    <int, Color>{},
  );
  ...
  static const MaterialColor yellow400 = MaterialColor(
    0xFFFBBF24,
    <int, Color>{},
  );

  static const MaterialColor yellow200 = MaterialColor(
    0xFFFDE68A,
    <int, Color>{},
  );

  static const MaterialColor slate200 = MaterialColor(
    0xFFE2E8F0,
    <int, Color>{},
  );

  static const MaterialColor slate300 = MaterialColor(
    0xFFCBD5E1,
    <int, Color>{},
  );

  static const MaterialColor slate400 = MaterialColor(
    0xFF94A3B8,
    <int, Color>{},
  );

  static const MaterialColor emerald200 = MaterialColor(
    0xFFA7F3D0,
    <int, Color>{},
  );

  static const MaterialColor emerald900 = MaterialColor(
    0xFF064E3B,
    <int, Color>{},
  );

  static const MaterialColor amber900 = MaterialColor(
    0xFF78350F,
    <int, Color>{},
  );

  static const MaterialColor slate900 = MaterialColor(
    0xFF0F172A,
    <int, Color>{},
  );
  ...
  static const Color difficultyEasyBackgroundDark = Color.fromARGB(
    102,
    46,
    125,
    50,
  ...
  static const Color difficultyMediumBackgroundDark = Color.fromARGB(
    186,
    93,
    64,
    55,
  ...
  static const Color difficultyHardBackgroundDark = Color.fromARGB(
    205,
    74,
    44,
    58,
