...
class PayUConfig {
  ...
  static String get apiKey =>
      dotenv.env['PAYU_API_KEY'] ?? '4Vj8eK4rloUd272L48hsrarnUA';
  static String get apiLogin =>
      dotenv.env['PAYU_API_LOGIN'] ?? 'pRRXKOl8ikMmt9u';

  static String get baseUrl =>
      dotenv.env['PAYU_BASE_URL'] ?? 'https://sandbox.api.payulatam.com';
  ...
  static String get responseUrl =>
      dotenv.env['PAYU_RESPONSE_URL'] ?? 'https://www.google.com';
  static String get confirmationUrl =>
      dotenv.env['PAYU_CONFIRMATION_URL'] ?? 'https://www.google.com';

  static bool get testMode =>
      dotenv.env['PAYU_TEST_MODE'] == 'true' ||
      dotenv.env['PAYU_TEST_MODE'] == null;
