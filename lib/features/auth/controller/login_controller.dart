...
import 'package:goncook/features/auth/domain/usecases/logout_usecase.dart' show LogoutUseCase;
import 'package:goncook/features/auth/domain/usecases/register_usecase.dart' show RegisterUseCase;
...
class LoginController extends BaseController {
  ...
  Future<(bool, String)> login({
    ...
    try {
      ...
      if (result.isSuccess) {
        _currentUser.value = result.valueOrNull;
