...
import 'package:goncook/core/services/network/network.dart';
...
class UserRepository implements IUserRepository {
  ...
  @override
  Future<(bool, String)> signInOrRegister(AuthModel user, {int? type}) async {
    try {
  ...
  Future<bool> loginWithEmail(AuthModel user) async {
    try {
      final result = await _apiService.post<AuthModel>(
        endpoint: '$path/login',
        body: user.toJson(),
  ...
  @override
  Future<bool> register(AuthModel user, {int? type}) async {
    try {
  ...
  Future<AuthModel> getUser() async {
    try {
      ...
      return userData ?? AuthModel.empty();
    } catch (e, stackTrace) {
