...
class FirebaseUserAuthRepository implements IUserAuthRepository {
  ...
  @override
  Future<AppResultService<AuthModel>> authenticateGoogle() async {
    try {
  ...
  @override
  Future<AppResultService<AuthModel>> authenticateEmail(Email email, String password) async {
    try {
  ...
  //}
  @override
  Future<AppResultService<AuthModel>> register(UserModel user) async {
    try {
  ...
  @override
  Future<AppResultService<UserModel?>> getCurrentUser() async {
